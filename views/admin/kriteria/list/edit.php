...
<div class="container">
	<div class="content-wrapper">
		<div class="row">
			<div class="col-sm-12">
				<h2>Edit Kriteria List (<?=$kriteria->nama?>)</h2>
				<?php if ($error) { ?>
			...
			<div class="col-sm-12">
				<form method="post" action="<?= base_url() ?>/admin/kriteria/list/update">
					<input type="hidden" name="id" value="<?= $list->id ?>">
					<div class="form-group">
						<label for="list_label">Nama</label>
						<input type="text" name="list_label" class="form-control" placeholder="Nama" required="" value="<?= $list->list_label ?>">
						<span class="form-error list_label">Nama List tidak boleh kosong</span>
					</div>
					<div class="form-group">
						<label for="list_value">Nilai</label>
						<input type="number" name="list_value" step="any" class="form-control" placeholder="Nilai" required="" max="<?=$kriteria->bobot?>" min="0" value="<?= $list->list_value ?>">
